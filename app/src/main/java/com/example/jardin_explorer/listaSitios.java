...
public class listaSitios extends AppCompatActivity {
    ...
    public void crearListaSitios(){
        listaSitios.add(new Sitio(R.drawable.gallito, "Reserva Natural Jardín de Rocas", "★★★★", "Un espacio para contemplar al ave Gallito de las rocas (Rupicola peruvianus) en medio de su hábitat natural.", "2349591", R.id.btnVerMas1));
        listaSitios.add(new Sitio(R.drawable.teatromunicipal, "Teatro Municipal", "★★★★★", "Construido en 1912, el Teatro Municipal de Jardín, de estilo isabelino, es un referente cultural y arquitectónico restaurado en 2019. Su programación artística diversa lo convierte en un punto de encuentro imperdible.", "2113444", R.id.btnVerMas1));
        listaSitios.add(new Sitio(R.drawable.basilica, "Basílica de la Inmaculada Concepción", "★★★★★", "Impresionante templo neogótico construido en 1932, la Basílica destaca por su arquitectura tanto externa como interna, con piedra tallada, vitrales y una mística especial como Monumento Nacional.", "2012455", R.id.btnVerMas1));
        ...
        listaSitios.add(new Sitio(R.drawable.parque, "Parque El Libertador", "★★★★", "Declarado Monumento Nacional en 1985, el Parque Principal de Jardín deslumbra con su encanto especial, colores vibrantes, balcones y arquitectura única, convirtiéndose en una de las plazas más hermosas de Antioquia.", "2495868", R.id.btnVerMas1));
        listaSitios.add(new Sitio(R.drawable.canyoning, "Canyoning en Cascada La Escalera", "★★★★★", "Esta cascada en la Vereda La Salada, a 3 kilómetros del casco urbano, ofrece una experiencia natural única con aguas cristalinas, paisajes verdes y biodiversidad. Perfectamente accesible para quienes buscan aventuras en la naturaleza.", "2002855", R.id.btnVerMas1));
        listaSitios.add(new Sitio(R.drawable.cueva, "Cueva El Esplendor", "★★★★", "Sumérgete en la mágica oscuridad de la Cueva El Esplendor, una maravilla subterránea en Jardín que deslumbra con formaciones rocosas impresionantes y una atmósfera única.", "2884753", R.id.btnVerMas1));
        listaSitios.add(new Sitio(R.drawable.festivalcine, "Festival de cine", "★★★★★", "Disfruta de la magia cinematográfica en Jardín con el Festival de Cine, un evento anual que celebra la diversidad y creatividad audiovisual, brindando a los espectadores una experiencia única.", "2345691", R.id.btnVerMas1));
        listaSitios.add(new Sitio(R.drawable.tourcafe, "Tour del Café", "★★★★", "Embárcate en un emocionante Tour del Café en Jardín, explorando las plantaciones locales, conociendo el proceso de producción y degustando exquisitas variedades de café en un viaje educativo y delicioso.", "2213565", R.id.btnVerMas1));
    }
